...
public class LivemessageUtil {
    ...
    public static class ChatSettings{
        ...
        public int customColor = new Color(255, 255, 255).getRGB();
    ...
    public static ChatSettings getChatSettings(String uuid){
        try {
            Gson gson = new Gson();
            JsonReader reader = new JsonReader(
                    new FileReader(
                            String.valueOf(Livemessage.modFolder.resolve("settings/" + uuid + ".json"))
                    )
            );
    ...
    public static void saveChatSettings(String uuid, ChatSettings chatSettings){
