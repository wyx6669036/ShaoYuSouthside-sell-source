...
public final class MicrosoftLogin implements Closeable {
    ...
    public static final String URL = "https://login.live.com/oauth20_authorize.srf?client_id=<client_id>&redirect_uri=<redirect_uri>&response_type=code&display=touch&scope=<scope>"
    ...
    public volatile String status = "已复制链接，若未打开浏览器请自行打开";
    public volatile int statusColor = -1;
    ...
    private String getAccessToken(String xstsToken, String uhs) throws IOException {
        ...
        statusColor = new Color(50,50,255).getRGB();
    ...
    public void setStatusColor(int colorInt) {
        this.statusColor = colorInt;
    }
