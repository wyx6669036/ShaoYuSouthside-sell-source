package dev.diona.southside.util.render.video;

import dev.diona.southside.util.misc.Logger;
...
public class VideoPlayer {
    ...
    public void init(ResourceLocation resource) throws FFmpegFrameGrabber.Exception {
        ...
        try {
            ...
            throw new RuntimeException("Failed to load video resource: " + resource.toString(), e);
        }
