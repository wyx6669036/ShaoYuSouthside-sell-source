...
public class SideBar {
    private final List<BasicButton> buttons = new ArrayList<BasicButton>() {{
        ...
        add(new BasicButton(width, SIZE_36, "Client", SVGs.CLIENT, null, ALIGNMENT_LEFT, ColorPalette.PRIMARY));
        add(new BasicButton(width, SIZE_36, "Combat", SVGs.COMBAT, null, ALIGNMENT_LEFT, ColorPalette.TERTIARY));
        add(new BasicButton(width, SIZE_36, "Misc", SVGs.MISC, null, ALIGNMENT_LEFT, ColorPalette.TERTIARY));
        add(new BasicButton(width, SIZE_36, "Movement", SVGs.MOVEMENT, null, ALIGNMENT_LEFT, ColorPalette.TERTIARY));
        add(new BasicButton(width, SIZE_36, "Player", SVGs.PLAYER, null, ALIGNMENT_LEFT, ColorPalette.TERTIARY));
        add(new BasicButton(width, SIZE_36, "Render", SVGs.RENDER, null, ALIGNMENT_LEFT, ColorPalette.TERTIARY));
        add(new BasicButton(width, SIZE_36, "World", SVGs.WORLD, null, ALIGNMENT_LEFT, ColorPalette.TERTIARY));
...
//        add(new BasicButton(width, SIZE_36, "Themes", SVGs.BRUSH, null, ALIGNMENT_LEFT, ColorPalette.TERTIARY));
    ...
    public SideBar() {
        ...
        for (int i = 1; i <= 7; i++) {
            int finalI = i - 1;
            buttons.get(i).setClickAction(new ModsPage(finalI));
        }
...
//        buttons.get(9).draw(vg, x + 16, calcAndIncrementLn(sidebarY), inputHandler);
        sidebarY = 0;
