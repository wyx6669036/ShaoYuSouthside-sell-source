...
public class SVGs {
    ...
    public static final SVG ONECONFIG_HEAD_DARK = new SVG("/assets/oneconfig/icons/OneConfigHeadDark.svg");
    ...
    public static final SVG SOUTHSIDE = new SVG("/assets/minecraft/southside/icon_white.svg");
    public static final SVG SKIDONION = new SVG("/assets/minecraft/southside/skidonion.svg");

    public static final SVG CLIENT = new SVG("/assets/oneconfig/icons/client.svg");
    public static final SVG COMBAT = new SVG("/assets/oneconfig/icons/combat.svg");
    public static final SVG MISC = new SVG("/assets/oneconfig/icons/misc.svg");
    public static final SVG MOVEMENT = new SVG("/assets/oneconfig/icons/movement.svg");
    public static final SVG PLAYER = new SVG("/assets/oneconfig/icons/player.svg");
    public static final SVG RENDER = new SVG("/assets/oneconfig/icons/render.svg");
    public static final SVG WORLD = new SVG("/assets/oneconfig/icons/world.svg");
    public static final SVG LOCKED = new SVG("/assets/oneconfig/icons/locked.svg");

    public static final SVG NOTIFICATION_ENABLED = new SVG("/assets/oneconfig/icons/NotificationEnabled.svg");
    public static final SVG NOTIFICATION_DISABLED = new SVG("/assets/oneconfig/icons/NotificationDisabled.svg");
