...
//                builder.append("\n");
//                if (OneConfigConfig.currentProfile.getValue().equals(profile)) builder.append(ChatColor.GREEN);
...
//        public void SwitchProfile(@Description("Profile Name") @Greedy String profile) {
