...
//            }
            ...
            //$$             gui.ifPresent(minecraftScreenScreenBiFunction -> ForgeCompat.compatMods.put(new ForgeCompat.ForgeCompatMod(container.getModId(), Category.THIRD_PARTY), () -> {
...
//                    }
//                }
//                ForgeCompat.compatMods.put(new ForgeCompat.ForgeCompatMod(mod.getName(), Category.THIRD_PARTY), () -> new TickDelay(() -> {
...
//                : modLogoFile;
//
//        ForgeCompat.compatMods.put(new ForgeCompat.ForgeCompatMod(mod.getName(), Category.THIRD_PARTY, icon), () -> {
//            try {
