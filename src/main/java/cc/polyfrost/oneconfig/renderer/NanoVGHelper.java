...
public interface NanoVGHelper {
     ...
     * @see Font
     */
    void drawTextWithFormatting(long vg, String text, float x, float y, int color, float size, Font font);
     ...
     * @see Font
     */
    void drawRawText(long vg, String text, float x, float y, int color, float size, Font font);
     ...
     * @see Font
     */
    void drawRawTextWithFormatting(long vg, String text, float x, float y, int color, float size, Font font);
    ...
    float getTextHeight(long vg, float fontSize, Font font);
    /**
    ...
    void drawDropShadow(long vg, float x, float y, float w, float h, float blur, float spread, float cornerRadius, Color color);
