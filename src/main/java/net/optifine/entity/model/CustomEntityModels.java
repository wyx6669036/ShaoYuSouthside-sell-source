...
public class CustomEntityModels {
	...
	private static Map<Class<? extends TileEntity>, TileEntitySpecialRenderer<? extends TileEntity>> getTileEntityRenderMap() {
		...
		if (originalTileEntityRenderMap == null) {
			originalTileEntityRenderMap = new HashMap<Class<? extends TileEntity>, TileEntitySpecialRenderer<? extends TileEntity>>(map);
		}
	...
	private static boolean modifyModel(ModelAdapter modelAdapter, ModelBase model, CustomModelRenderer[] modelRenderers,
			ModelResolver mr) {
	...
	private static boolean modifyModel(ModelAdapter modelAdapter, ModelBase model,
			CustomModelRenderer customModelRenderer, ModelResolver modelResolver) {
