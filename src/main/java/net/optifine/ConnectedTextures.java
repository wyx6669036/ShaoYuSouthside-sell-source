...
public class ConnectedTextures {
	...
	public static void switchValues(int ix1, int ix2, boolean[] arr) {
	...
	private static TextureAtlasSprite getNeighbourIcon(IBlockAccess iblockaccess, IBlockState blockState,
		...
		if (ibakedmodel == null) {
			...
			List<BakedQuad> list = ibakedmodel.getQuads(neighbourState, enumfacing, 0L);
			...
			if (list == null) {
				...
				if (list.size() > 0) {
					...
					List<BakedQuad> list1 = ibakedmodel.getQuads(neighbourState, null, 0L);
