...
public class GuiDisconnected extends GuiScreen
{
    ...
    {
        backgrounds = new Image("/assets/minecraft/southside/image/xibao.png");
    ...
    public void initGui()
    {
        ...
        this.multilineMessage = this.fontRenderer.listFormattedStringToWidth(this.message.getFormattedText(), Math.max(this.width - 50, 10));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        nanovg.setupAndDraw(true, vg -> {
            nanovg.drawImage(vg, backgrounds, 0, 0, scaledResolution.getScaledWidth(), scaledResolution.getScaledHeight());;
        });
