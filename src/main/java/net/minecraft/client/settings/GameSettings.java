...
public class GameSettings
{
    ...
    public boolean autoRemoveOldPacks = true;
    ...
    public void setOptionValue(Options settingsOption, int value)
    {
        ...
        if (settingsOption == Options.AUTO_REMOVE_OLD_PACKS)
        {
            this.autoRemoveOldPacks = !this.autoRemoveOldPacks;
        }
    ...
    public boolean getOptionOrdinalValue(Options settingOption)
    {
        switch (settingOption)
        {
            ...
            case AUTO_REMOVE_OLD_PACKS:
                return this.autoRemoveOldPacks;
                ...
                if (this.optionsFile.exists())
                {
                    ...
                    for (String s1 : nbttagcompound.getKeySet())
                    {
                        ...
                        try
                        {
                            ...
                            if ("autoRemoveOldPacks".equals(s1)) {
                                this.autoRemoveOldPacks = "true".equals(s2);
                            }
    ...
    public void saveOptions()
    {
        ...
        try
        {
            ...
            printwriter.println("autoRemoveOldPacks: " + this.autoRemoveOldPacks);
    ...
    public static enum Options
    {
        ...
        AUTO_REMOVE_OLD_PACKS("Auto Remove Old Packs", false, true);
