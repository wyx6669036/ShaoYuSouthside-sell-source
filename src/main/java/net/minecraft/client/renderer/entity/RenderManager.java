...
import dev.diona.southside.module.modules.render.Perspective;
...
public class RenderManager {
	...
	public void cacheActiveRenderInfo(World worldIn, FontRenderer textRendererIn, Entity livingPlayerIn,
		...
		if (livingPlayerIn instanceof EntityLivingBase && ((EntityLivingBase) livingPlayerIn).isPlayerSleeping()) {
			...
			this.playerViewY = Perspective.getCameraPrevYaw() + (Perspective.getCameraYaw() - Perspective.getCameraPrevYaw()) * partialTicks;
			this.playerViewX = Perspective.getCameraPrevPitch() + (Perspective.getCameraPitch() - Perspective.getCameraPrevPitch()) * partialTicks;
		}
