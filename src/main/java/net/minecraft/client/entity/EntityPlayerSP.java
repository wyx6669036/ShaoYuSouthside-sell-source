...
//        }
    ...
    public void onLivingUpdate() {
        ...
        if (((this.isHandActive() || (KillAura.getBlocking() && !KillAura.getAutoBlockMode().equals("Fake"))) && !this.isRiding()) || Southside.moduleManager.getModuleByClass(AutoGapple.class).isEnabled()) {
