...
import dev.diona.southside.module.modules.render.Ambience;
...
public abstract class Biome
{
    ...
    {
        Ambience a = (Ambience) Southside.moduleManager.getModuleByClass(Ambience.class);
        if (a.weatherValue.getValue().equals("Snow")) return true;
