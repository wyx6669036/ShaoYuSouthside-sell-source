...
public class BlockStateContainer
{
    ...
    protected StateImplementation createState(Block p_createState_1_, ImmutableMap < IProperty<?>, Comparable<? >> p_createState_2_)
    {
        return new StateImplementation(p_createState_1_, p_createState_2_);
    }

    public BlockStateContainer(Block p_i2_1_, IProperty<?>[] p_i2_2_)
    {
        this.block = p_i2_1_;
        ...
        for (List < Comparable<? >> list1 : Cartesian.cartesianProduct(this.getAllowedValues()))
        {
            ...
            StateImplementation blockstatecontainer$stateimplementation = this.createState(p_i2_1_, ImmutableMap.copyOf(map1));
    ...
    public static class Builder
    {
        ...
        {
            this.listed.addAll(Arrays.asList(p_add_1_));
            return this;
        }
