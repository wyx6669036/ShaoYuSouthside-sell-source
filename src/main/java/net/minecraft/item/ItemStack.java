...
public class ItemStack
{
    ...
    public float getDestroySpeed(Block blockIn)
    {
            return this.getItem().getDestroySpeed(this, blockIn.getDefaultState());
    }
    ...
    public ItemStack useItemRightClick2(World worldIn, EntityPlayer playerIn)
    {
        return this.getItem().onItemRightClick2(this, worldIn, playerIn);
    }
    /**
...
//    }
    ...
    public ItemStack setCount(int size)
    {
        this.stackSize = size;
        this.updateEmptyState();
        return this;
